...
| 概念 | 是什麼 | 關鍵規則 / 幾何意義 |
|---|---|---|
| vector(向量) | 一串有順序的數字 | 在 AI 裡可以想成高維空間裡的一個點 |
...
**Q1：element-wise multiplication(逐元素相乘)跟 matrix multiplication(矩陣乘法)差在哪裡?各自對形狀(shape)有什麼要求?**
...
**Q2：`relu(W @ x + b)` 這一行代表神經網路的一層,W、b、relu 三個部分各自扮演什麼角色?**
...
**Q3：broadcasting 最常在什麼情境下被觸發?判斷規則是什麼?**
