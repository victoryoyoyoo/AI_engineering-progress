...
**Q1：在機器學習的情境下,「optimization(最佳化)」具體是在解決什麼問題?**
...
**Q2：為什麼 mini-batch SGD 帶來的「雜訊(noise)」反而對訓練有幫助,而不是缺點?**
...
**Q3：cosine annealing 這種學習率排程(learning rate schedule)的邏輯是什麼?為什麼它在 Transformer 訓練中常被使用?**
