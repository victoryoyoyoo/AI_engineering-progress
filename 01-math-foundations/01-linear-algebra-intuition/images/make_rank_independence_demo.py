...
ax.set_title("線性獨立:v1、v2 撐出整個2維平面\nrank = 2(沒有冗餘方向)", fontsize=11, fontweight="bold")
...
ax.grid(alpha=0.3, linestyle="--")
ax.set_title("線性相依:v3 可由 v1、v2 組合出來\n加入 v3 仍是 rank = 2(v3 是冗餘方向)", fontsize=11, fontweight="bold")

fig.suptitle("linear independence(線性獨立) 與 rank(矩陣的秩)", fontsize=13, fontweight="bold", y=1.02)
plt.tight_layout()
