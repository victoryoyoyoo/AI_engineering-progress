...
ax.set_title("兩種方法算出幾乎一樣的梯度", fontsize=11, fontweight="bold")
...
ax.set_title("誤差遠小於門檻,引擎寫對了", fontsize=11, fontweight="bold")

fig.suptitle("Gradient Checking:用數值法驗證autodiff是否正確", fontsize=13, fontweight="bold")
plt.tight_layout()
