...
<details>
<summary><b>PCA做完降維後,發現用不同套件、不同次執行,算出來的主成分方向正負號不一樣,這是bug嗎?</b></summary>
...
<details>
<summary><b>資料集裡有兩群資料是同心圓分布,你會用標準PCA還是Kernel PCA?為什麼?</b></summary>
...
<details>
<summary><b>為什麼KNN這類依賴距離的演算法,在特徵維度很高時效果會明顯變差?</b></summary>
...
<details>
<summary><b>上線後要對一筆新資料做PCA降維,為什麼不能用這筆新資料自己重新算一次mean再置中?</b></summary>
