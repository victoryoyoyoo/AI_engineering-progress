...
<details>
<summary><b>訓練loss不再下降,梯度看起來也接近0,你會怎麼判斷模型是卡在局部最小值、鞍點,還是真的已經收斂?</b></summary>
...
<details>
<summary><b>為什麼深度學習訓練幾乎不用牛頓法,清一色用一階方法(SGD、Adam這類)?</b></summary>
...
<details>
<summary><b>學習率設太大跟設太小,分別會在訓練曲線上看到什麼徵兆?</b></summary>
