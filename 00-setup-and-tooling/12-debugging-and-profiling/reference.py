"""
Phase 0 Lesson 12: Debugging and Profiling
AI開發常用的除錯/效能分析工具:tensor debug print、計時、記憶體追蹤、
逐層shape檢查、NaN偵測、裝置(CPU/GPU)一致性檢查、梯度健康檢查、
GPU記憶體用量、結構化logging、條件式breakpoint。
"""
